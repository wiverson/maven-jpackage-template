...
- [Java 18](https://bell-sw.com/pages/downloads/#/java-18-current).
    - If you are using JavaFX, Liberica w/JavaFX is recommended as it bundles JavaFX.
...
SDKMAN! is installed, you can run the following to install Liberica and Maven.
